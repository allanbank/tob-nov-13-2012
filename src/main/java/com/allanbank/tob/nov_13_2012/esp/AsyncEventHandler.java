...
/**
 * AsyncEventHandler provides a aysnchronous version of the event handler for a
 ...
 */
public class AsyncEventHandler<E, O> {
    ...
    /** Gateway to send the output of the business logic. */
    protected final Gateway<O> gateway;
     ...
     *            Collection for storing events.
     */
    public AsyncEventHandler(final EventFactory<E> factory,
            final BusinessLogic<E, O> businessLogic, final Gateway<O> gateway,
     ...
     * 
     * @see SimpleEventHandler#handleEvent(Object)
     */
    public void handleEvent(final E event) {
        ...
        final Callback<Document> findAndModifyCallback = new Callback<Document>() {
            @Override
            public void callback(final Document doc) {
                ...
                for (final O outputEvent : output) {
    ...
    /**
     * Gateway provides an interface forwarding events.
     * 
     * @param <O>
     *            The type of the output events.
     * @copyright 2012, Allanbank Consulting, Inc., All Rights Reserved
     */
    public static interface Gateway<O> {
        /**
         * Forward the output event for further processing.
         * 
         * @param outputEvent
         *            The output event from this business logic.
         */
        public void send(O outputEvent);
    }
}
